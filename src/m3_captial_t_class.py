...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.point1 = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y - letter_thickness/2)
        self.point2 = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y + (height - (letter_thickness/2)))
        self.point3 = rg.Point(intersection_center.x - self.width, intersection_center.y - letter_thickness/2)
        self.point4 = rg.Point(intersection_center.x + self.width, intersection_center.y + letter_thickness / 2)
        self.h_rect = rg.Rectangle(self.point3, self.point4)
        self.v_rect = rg.Rectangle(self.point1, self.point2)
